...
{
    public class SingleGunStateMachineFactory : BulletWeaponStateMachineFactoryBase
    {
        public SingleGunStateMachineFactory(IBulletViewFactory bulletViewFactory, BulletFactory bulletFactory) : base(
