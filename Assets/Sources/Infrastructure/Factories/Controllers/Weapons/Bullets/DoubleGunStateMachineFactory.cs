...
{
    public class DoubleGunStateMachineFactory : BulletWeaponStateMachineFactoryBase
    {
        public DoubleGunStateMachineFactory(IBulletViewFactory bulletViewFactory, BulletFactory bulletFactory) : base(
