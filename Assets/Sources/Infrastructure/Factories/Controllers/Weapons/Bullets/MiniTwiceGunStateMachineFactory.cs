...
{
    public class MiniTwiceGunStateMachineFactory : BulletWeaponStateMachineFactoryBase
    {
        public MiniTwiceGunStateMachineFactory(IBulletViewFactory bulletViewFactory, BulletFactory bulletFactory) :
            base(bulletViewFactory, bulletFactory)
        {
        }
