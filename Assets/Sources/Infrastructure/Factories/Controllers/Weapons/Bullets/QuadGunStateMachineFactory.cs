...
{
    public class QuadGunStateMachineFactory : BulletWeaponStateMachineFactoryBase
    {
        public QuadGunStateMachineFactory(IBulletViewFactory bulletViewFactory, BulletFactory bulletFactory) : base(
