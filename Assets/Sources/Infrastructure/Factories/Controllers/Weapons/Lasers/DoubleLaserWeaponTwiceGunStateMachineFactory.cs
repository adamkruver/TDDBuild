...
{
    public class DoubleLaserWeaponTwiceGunStateMachineFactory : LaserWeaponStateMachineFactoryBase
    {
        public DoubleLaserWeaponTwiceGunStateMachineFactory(ILaserViewFactory laserViewFactory, LaserFactory laserFactory) : base(laserViewFactory, laserFactory)
        {
        }
