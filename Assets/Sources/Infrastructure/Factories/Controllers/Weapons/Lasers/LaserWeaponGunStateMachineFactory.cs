...
{
    public class LaserWeaponGunStateMachineFactory : LaserWeaponStateMachineFactoryBase
    {
        public LaserWeaponGunStateMachineFactory(ILaserViewFactory laserViewFactory, LaserFactory laserFactory) : base(
        ...
        )
        {
            ...
            ToTrackTargetTransition toTrackTargetTransition =
                new ToTrackTargetTransition(trackTargetState, weapon);
